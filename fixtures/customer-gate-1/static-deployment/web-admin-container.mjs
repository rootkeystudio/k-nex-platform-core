...
const proof = await (async () => {
  ...
  if (!deploymentTableDenied || !sourceWriteDenied || !buildDenied || !dockerDenied) throw new Error("Web/admin isolation attempt unexpectedly gained static deployment authority.");
  return Object.freeze({ deploymentTableDenied, sourceWriteDenied, buildDenied, dockerDenied, processId: process.pid });
})();
