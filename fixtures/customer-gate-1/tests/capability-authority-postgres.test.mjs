...
test("reauthorizes generation and actor authority and keeps replay denial across gateway restart", { timeout: 180_000 }, async () => {
  ...
  try {
    ...
    revokedToken = issue({ tokenId: "capability-token-2", invocationId: "capability-invocation-2", generationId: "sales-generation-new", delegationId: "delegation-revoked" });
    ...
    actorRevokedToken = issue({ tokenId: "capability-token-actor-revoked", invocationId: "capability-invocation-actor-revoked", generationId: "sales-generation-new" });
    ...
    const restartToken = issue({ tokenId: "capability-token-3", invocationId: "capability-invocation-3", generationId: "sales-generation-new" });
