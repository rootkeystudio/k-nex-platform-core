  ...
  try {
    ...
    const migrated = await query(connectionString, `
      select
        ...
        (select count(*)::int from payload_migrations where name = '20260829_000009_extension_activation') as extension_activation_migration_count,
        (select count(*)::int from payload_migrations where name = '20260829_000010_theme_skin_profiles') as theme_skin_profiles_migration_count,
        (select count(*)::int from payload_migrations where name = '20260829_000011_static_deployment') as static_deployment_migration_count,
        (select count(*)::int from payload_migrations where name = '20260829_000012_verified_artifacts') as verified_artifacts_migration_count,
        ...
        (select count(*)::int from payload_migrations where name = '20260902_000024_catalog_mirror') as catalog_mirror_migration_count,
        (select count(*)::int from payload_migrations where name = '20260902_000025_system_operations') as system_operations_migration_count,
        ...
        to_regclass('public.runtime_static_deployments')::text as static_deployments,
        to_regclass('public.runtime_static_generation_retirements')::text as static_generation_retirements,
        to_regclass('public.runtime_worker_generation_fences')::text as worker_generation_fences,
        to_regclass('public.runtime_extension_artifacts')::text as extension_artifacts,
        to_regclass('public.runtime_extension_artifact_acceptances')::text as extension_artifact_acceptances,
        ...
        to_regclass('public.runtime_static_composition_checkpoints')::text as static_composition_checkpoints,
        to_regclass('public.runtime_static_release_requests')::text as static_release_requests,
        to_regclass('public.runtime_extension_runner_quarantine_receipts')::text as runner_quarantine_receipts,
        to_regclass('public.k_nex_catalog_mirror_state')::text as catalog_mirror_state,
        to_regclass('public.k_nex_system_operations_state')::text as system_operations_state,
    ...
    assert.deepEqual(migrated.rows, [{
      ...
      extension_activation_migration_count: 1,
      theme_skin_profiles_migration_count: 1,
      static_deployment_migration_count: 1,
      verified_artifacts_migration_count: 1,
      ...
      catalog_mirror_migration_count: 1,
      system_operations_migration_count: 1,
      ...
      static_deployments: "runtime_static_deployments",
      static_generation_retirements: "runtime_static_generation_retirements",
      worker_generation_fences: "runtime_worker_generation_fences",
      extension_artifacts: "runtime_extension_artifacts",
      extension_artifact_acceptances: "runtime_extension_artifact_acceptances",
    ...
    assert.equal(current.rows[0].count, 25);
