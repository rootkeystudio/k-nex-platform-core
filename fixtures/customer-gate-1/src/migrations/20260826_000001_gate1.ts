...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "sales_tasks" (
    ...
    "status" "enum_sales_tasks_status" DEFAULT 'open' NOT NULL,
  ...
  CREATE TABLE "k_nex_migration_revision" (
  "id" integer PRIMARY KEY NOT NULL,
  "predecessor_revision" integer NOT NULL,
  "revision" integer NOT NULL
  );

  INSERT INTO "k_nex_migration_revision" ("id", "predecessor_revision", "revision") VALUES (1, 0, 1);
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "k_nex_migration_revision" CASCADE;
