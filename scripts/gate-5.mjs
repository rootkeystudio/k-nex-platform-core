...
import { CMS_PAGE_REVISIONS_SLUG, CMS_PUBLICATION_PAIRS_SLUG, UI_DOCUMENT_REVISIONS_SLUG } from "../packages/payload-builder-storage/dist/index.js";
...
assert.deepEqual([UI_DOCUMENT_REVISIONS_SLUG, CMS_PAGE_REVISIONS_SLUG, CMS_PUBLICATION_PAIRS_SLUG], ["k-nex-ui-document-revisions", "k-nex-cms-page-revisions", "k-nex-cms-publication-pairs"]);
...
console.log(JSON.stringify({ gate: "Gate 5", themes: [minimalThemePackage.id, neobrutalismThemePackage.id], primitives: semanticPrimitiveNames.length, storageCollections: [UI_DOCUMENT_REVISIONS_SLUG, CMS_PAGE_REVISIONS_SLUG, CMS_PUBLICATION_PAIRS_SLUG], pluginCandidatesInstalled: [] }, null, 2));
