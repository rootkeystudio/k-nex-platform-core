...
test("plugin conformance requires repeated packs and canonical committed payload bytes to match", () => {
  ...
  const changed = gzipSync(Buffer.from("changed package payload"), { level: 1, mtime: 0 });
  changed[9] = 0x03;
