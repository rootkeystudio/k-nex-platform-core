...
Exact Node 24.19.0: `pnpm gate:12:focused` PASS, including 19 contract tests, two real process proofs, and 22/22 attack mappings. Cumulative checks fixed a direct React Aria boundary escape, stale pre-v1 Sales form input, and fixture-category count. The current failure is the Sales export inventory omitting the new Puck entrypoint; focused Sales rerun is required.
