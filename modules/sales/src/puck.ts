...
const fixedCrmBlocks = new Set(["sales.account-list", "sales.account-detail", "sales.contact-list", "sales.contact-detail", "sales.lead-list", "sales.lead-detail", "sales.opportunity-list", "sales.opportunity-detail", "sales.pipeline-settings", "sales.saved-views"]);
