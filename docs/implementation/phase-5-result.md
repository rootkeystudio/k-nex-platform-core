...
- Selector ownership does not disable normal CSS inheritance. An inner theme must explicitly define inherited properties it owns; the proof does not claim a shadow-DOM-style inheritance boundary.
