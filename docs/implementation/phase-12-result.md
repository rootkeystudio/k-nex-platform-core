...
`pnpm gate:12:focused` builds the affected Phase 12 graph, verifies the exact v1 packed closure, runs 132 selected contract/navigation/shell/administration/builder/service/generator/Sales tests, then runs three real PostgreSQL/HTTP/Chromium process proofs. It machine-maps all 22 contracted attack IDs to evidence that actually passed.
