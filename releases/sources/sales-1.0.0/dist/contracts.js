...
const opportunityDetailSourcePolicy = { required: true, contracts: [{ id: "table.records", version: 1 }], requiredFields: ["name", "owner-id", "team-id", "account-id", "primary-contact-id", "pipeline-id", "stage-id", "archive-status", "revision"] };
