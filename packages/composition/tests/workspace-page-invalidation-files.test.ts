...
describe("generated workspace invalidation runtime", () => {
  it("keeps a navigation-only user from Sales Settings by matching direct route admission predicates", () => {
    ...
    expect(navigation).toContain('implementedSystemRouteIds: ["system.route.workspace", "system.route.roles", "system.route.permissions", "system.route.assignments", "system.route.workspace-pages"]');
