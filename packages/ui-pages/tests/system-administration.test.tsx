...
import {
  ...
  SystemOperationDetailPage, SystemOperationsPage, SystemThemeProfileDetailPage, SystemThemesPage
} from "../src/index.js";
...
describe("system administration pages", () => {
  it("renders the twelve fixed administration routes from server-produced view models", () => {
    const pages = [
    ...
    expect(markup.match(/<main/g)).toHaveLength(12);
    expect(markup.match(/data-k-nex-component="skip-link"/g)).toHaveLength(12);
    expect(markup.match(/aria-label="System administration"/g)).toHaveLength(12);
