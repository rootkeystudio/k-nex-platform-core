...
function systemView<T extends object>(view: T): T & Readonly<{ readonly navigation: readonly SystemAdministrationNavigationItem[] }> {
  return { navigation: systemAdministrationNavigation, ...view };
}
...
describe("system administration pages", () => {
  it("renders the sixteen fixed administration routes from server-produced view models", () => {
    const pages = [
      <SystemRolesPage view={systemView({ title: "Roles", roles: [{ id: "owner", label: "Owner", href: "/system/access/roles/owner", permissionCount: "2", assignmentCount: "1", state: "active" }], createRole: formAction("Create role", "/api/system/access/roles") })} />,
      <SystemRoleDetailPage view={systemView({ title: "Role", roleLabel: "Manager", roleState: "active", activePermissionGroups: [{ owner: "Platform system", resources: [{ resource: "roles", operations: [{ operation: "manage", permissions: [{ label: "system.roles.manage", add: formAction("Add permission", "/api/system/access/roles/manager/permissions"), remove: formAction("Remove permission", "/api/system/access/grants/grant-roles-manage/remove") }] }] }] }], templates: [{ id: "sales-manager", title: "Sales manager", instantiate: formAction("Instantiate template", "/api/system/access/templates/instantiate"), copySelected: formAction("Copy template permissions", "/api/system/access/templates/copy") }], inactiveDiagnostics: [{ id: "retired", label: "sales.pipeline.manage", state: "inactive-generation-retired", detail: "The retired generation cannot authorize." }], save: action })} />,
      <SystemPermissionsPage view={systemView({ title: "Permissions", permissions: [{ id: "roles", label: "system.roles.manage", owner: "Platform system", resource: "roles", operation: "manage", state: "active" }], state: "stale", refresh: action })} />,
      <SystemAssignmentsPage view={systemView({ title: "Assignments", assignments: [{ id: "assignment", principal: "user:alex", role: "Owner", state: "active", revision: "42", revoke: formAction("Revoke assignment", "/api/system/access/assignments/assignment/revoke") }, { id: "revoked-assignment", principal: "user:sam", role: "Manager", state: "revoked", revision: "43", reactivate: formAction("Reactivate assignment", "/api/system/access/assignments/revoked-assignment/reactivate") }], createAssignment: formAction("Create assignment", "/api/system/access/assignments"), manageAssignments: formAction("Manage assignments", "/api/system/access/assignments/manage") })} />,
      <SystemTemplatesPage view={systemView({ title: "Templates", templates: [{ id: "sales-manager", title: "Sales manager", owner: "module.sales", version: "1", state: "active", instantiate: formAction("Instantiate template", "/api/system/access/templates/instantiate") }] })} />,
      <SystemAuthorizationAuditPage view={systemView({ title: "Authorization audit", events: [{ id: "audit", occurredAt: "2026-09-01", outcome: "deny", reason: "approval-required", permission: "system.extensions.update", owner: "Platform system", revision: "42" }] })} />,
      <SystemExtensionsPage view={systemView({ title: "Extensions", extensions: [{ id: "sales", label: "Sales", href: "/system/extensions/module.sales", deliveryClassLabel: "Platform Plugin", availabilityLabel: "maintenance-required", lifecycleLabel: "active", revision: "42" }] })} />,
      <SystemExtensionDetailPage view={systemView({ title: "Extension", extensionLabel: "Sales", extensionId: "module.sales", deliveryClassLabel: "Platform Plugin", availabilityLabel: "maintenance-required", lifecycleLabel: "active", impact: "Migration affects sales records.", approval: "Approval required.", audit: "Audit event required.", plan: formAction("Plan extension change", "/api/system/extensions/plan"), execute: formAction("Execute extension change", "/api/system/extensions/module.sales/execute"), actions: [action], state: "denied" })} />,
      <SystemThemesPage view={systemView({ title: "Themes", packages: [{ id: "theme.default", label: "Default", version: "1.0.0", surfaces: "admin, public", availability: "installed", referenceImpact: "Blocked by 1 profile" }], skins: [{ id: "skin.accent", label: "Accent", version: "1.0.0", lifecycle: "active", actions: "Disable, uninstall" }], profiles: [{ id: "profile.admin", label: "Admin", href: "/system/themes/profiles/profile.admin", surface: "admin", package: "theme.default@1.0.0", skin: "skin.accent@1.0.0", revision: "2", accessibility: "passed" }] })} />,
      <SystemThemeProfileDetailPage view={systemView({ title: "Theme Profile", profileLabel: "Admin", profileId: "profile.admin", surface: "admin", package: "theme.default@1.0.0", skin: "skin.accent@1.0.0", publication: "draft", accessibility: "passed", preview: formAction("Preview profile", "/api/system/themes/profiles/profile.admin/preview"), stage: { ...formAction("Stage profile", "/api/system/themes/profiles/profile.admin/stage"), form: { ...formAction("Stage profile", "/api/system/themes/profiles/profile.admin/stage").form, textArea: { name: "profile", label: "Theme Profile JSON", value: '{"schemaVersion":1}' } } }, publish: { ...formAction("Publish profile", "/api/system/themes/profiles/profile.admin/publish"), form: { ...formAction("Publish profile", "/api/system/themes/profiles/profile.admin/publish").form, inputs: [{ name: "password", label: "Current password", type: "password" }] } }, rollback: formAction("Rollback profile", "/api/system/themes/profiles/profile.admin/rollback") })} />,
      <SystemOperationsPage view={systemView({ title: "Operations", revision: "7", operations: [{ id: "backup-operation-1", source: "backup", href: "/system/operations/backup-operation-1", state: "completed", receipt: "backup-receipt-1" }], health: [{ id: "health-1", source: "backup", state: "ready", revision: "7", checks: "backup.fresh, restore.clean" }], backup: formAction("Request backup", "/api/system/operations/backup"), restoreDrill: { ...formAction("Request restore drill", "/api/system/operations/restore-drill"), confirmation: { title: "Approve clean restore drill", description: "A separate operator restores into a clean environment.", confirmLabel: "Approve restore drill" } } })} />,
      <SystemOperationDetailPage view={systemView({ title: "Operation", operationId: "backup-operation-1", source: "backup", operationState: "completed", receipt: "backup-receipt-1", inventory: "sha256:aaaa", audit: "user:owner" })} />,
      <SystemSettingsPage view={systemView({ title: "Settings", settings: [{ id: "platform.general", label: "General", href: "/system/settings/platform.general", owner: "Platform system", state: "effective", revision: "3" }] })} />,
      <SystemSettingsDetailPage view={systemView({ title: "Settings", settingsId: "platform.general", settingsLabel: "General", owner: "Platform system", documentState: "effective", fields: [{ id: "siteName", label: "Site name", value: "K-Nex", state: "visible" }, { id: "apiKey", label: "API key", value: "••••••", state: "secret-reference" }], save: { ...formAction("Save settings", "/api/system/settings/platform.general"), form: { ...formAction("Save settings", "/api/system/settings/platform.general").form, textArea: { name: "values", label: "Settings JSON", value: '{"siteName":"K-Nex"}' } } } })} />,
      <SystemWorkspacePagesPage view={systemView({ title: "Workspace pages", folders: [{ id: "customer.folder.reports", label: "Reports", parent: "Sales", order: "20", revision: "1", update: formAction("Update folder", "/api/system/workspace-folders/customer.folder.reports") }], pages: [{ id: "workspace.page.sales", title: "Sales board", href: "/system/workspace-pages/workspace.page.sales", state: "published", placement: "Sales / 20", theme: "workspace.theme.default@workspace.theme.revision", impact: "ready", revision: "3/2/1" }], create: { label: "Create page", form: { actionUrl: "/api/system/workspace-pages", inputs: [{ name: "title", label: "Title", type: "text" }, { name: "parent", label: "Folder", type: "select", options: [{ value: "sales.navigation.root", label: "Sales" }] }] } }, createFolder: { label: "Create folder", form: { actionUrl: "/api/system/workspace-folders", inputs: [{ name: "label", label: "Folder name", type: "text" }] } } })} />,
      <SystemWorkspacePageDetailPage view={systemView({ title: "Workspace page", pageId: "workspace.page.sales", pageTitle: "Sales board", pageState: "published", placement: "Sales / 20", theme: "workspace.theme.default@workspace.theme.revision", impact: "ready", viewHref: "/workspace/pages/workspace.page.sales", editorHref: "/workspace/pages/workspace.page.sales/edit", access: [{ subject: "role:customer.sales-manager", capability: "view" }], audit: [{ id: "audit-one", operation: "publish", actor: "user:owner", revision: "3/2/1", occurredAt: "2026-09-03T08:00:00.000Z" }], archive: { ...formAction("Archive page", "/api/system/workspace-pages/workspace.page.sales/archive"), confirmation: { title: "Archive Sales board", description: "The page leaves navigation but retains its history." } } })} />
    ];
  ...
  it("renders server-projected native POST forms without client authority fields", () => {
    const markup = renderToStaticMarkup(<SystemExtensionDetailPage view={systemView({
  ...
  it("renders only the supplied workspace-pages subnavigation", () => {
    const markup = renderToStaticMarkup(<SystemWorkspacePagesPage view={{
    ...
    expect(markup).toContain('href="/system/workspace-pages"');
    expect(markup).not.toMatch(/href="\/system\/(?:access\/(?:roles|permissions|assignments|templates|audit)|extensions|themes|settings|operations)"/u);
  });

  it("renders accessible copy-permission selection instead of a fixed hidden subset", () => {
    const markup = renderToStaticMarkup(<SystemRoleDetailPage view={systemView({
